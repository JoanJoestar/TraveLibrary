...
<body>
	<?php
		...
		//**** Segundo son la Bse de Datos
			...
			$datos = array($usuario, $direccion, $libro, $fecha, $precio, $metodo_pago, );
			$Buscar ="";
			...
			if ($resultSearch){
				...
				exit();
                    ...
                    $consulta = "INSERT INTO datos_compra (nombre, libro, precio, direccion, metodo, fecha, EstadoPedido, USUARIO, NumTelefono) VALUES ('$usuario', '$libro', 
                    '$precio','$direccion', '$metodo_pago', '$fecha', 'Sin entregar', '".$_SESSION["usuario"]."','$NumTelefono')";
