...
<body>
    ...
    <div class="Div-pantalla-fondo">
		...
		// PARA VER LOS CAMBIOS COLOCO LA DIRECCION EN EL NAVEGADOR: [http://localhost/APP__TRAVELIBRARY/bandeja_pedidos.php]
		...
		//**** Segundo son la Bse de Datos
			...
			mysqli_set_charset ($conexion, "UTF8");
                ...
                echo "<form action = 'Borrar-datos_compra.php' method = 'post'>";
                    echo "<table class='tabla-pedidos'>";
                        ...
                        echo"<tr><td><input type='submit' name='enviando' id='buscar' value='Pedido completado'></td></tr>";
                    echo "</table>";
                echo "</form>";
