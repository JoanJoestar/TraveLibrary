    ...
    <div class="Div-pantalla-fondo">
            ...
            <div class="contenedor-titulo">
                ...
                <nav class="nav-main">
                    <ul class="nav-menu">
                        ...
                        <li><a href="favoritos-tematicas__librosUsuario.php">Favoritos & Tematicas</a></li>
                    </ul>
                </nav>
            <div class="bandeja_pedidos">
		<?php

		// PARA VER LOS CAMBIOS COLOCO LA DIRECCION EN EL NAVEGADOR: [http://localhost/APP__TRAVELIBRARY/bandeja_pedidos__Usuario.php]
		...
		//**** Segundo son la Bse de Datos
			...
			mysqli_set_charset ($conexion, "UTF8");
				...
				$consulta = "SELECT * FROM datos_compra WHERE USUARIO = '".$_SESSION["usuario"]."'";
